...
@Controller('/measurements/water/ec')
export class FetchWaterECController {
    constructor(private fetchWaterEC: FetchWaterECUseCase) {}
    ...
    async handle(
        ...
        const result = await this.fetchWaterEC.execute({
            page,
            pageSize,
            from,
            to
